...
C_SRCS += \
../Drivers/app_icm42688p/app_icm42688p.c 

OBJS += \
./Drivers/app_icm42688p/app_icm42688p.o 

C_DEPS += \
./Drivers/app_icm42688p/app_icm42688p.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/app_icm42688p/%.o Drivers/app_icm42688p/%.su Drivers/app_icm42688p/%.cyclo: ../Drivers/app_icm42688p/%.c Drivers/app_icm42688p/subdir.mk
...
clean: clean-Drivers-2f-app_icm42688p

clean-Drivers-2f-app_icm42688p:
	-$(RM) ./Drivers/app_icm42688p/app_icm42688p.cyclo ./Drivers/app_icm42688p/app_icm42688p.d ./Drivers/app_icm42688p/app_icm42688p.o ./Drivers/app_icm42688p/app_icm42688p.su

.PHONY: clean-Drivers-2f-app_icm42688p
